        ...
        <div className="font-sans">
          <div className="max-w-sm mx-auto px-6">
            <div className="relative flex flex-wrap">
              <div className="w-full relative border-3 rounded-3xl m-5 p-7 shadow-lg mt-0 ">
                <div className="mt-6">
                  ...
                  <div className="text-center font-semibold  text-4xl font-sans">
                    Deposit Amount
                            ...
                            {error && (                    
                          <p className=" text-red-200  text-sm border-red-500/30 rounded p-2">
                            {error}
                          </p>
                        )}
                  <form className="mt-8" onSubmit={HandleDeposit}>
                    <div className="mx-auto max-w-lg">
                      ...
                      <div className="flex justify-between">
                        ...
                        >
                          {loading ? "Please Wait...." : "Deposit Amount"}
                        </button>
                      </div>
                    </div>
                  </form>
