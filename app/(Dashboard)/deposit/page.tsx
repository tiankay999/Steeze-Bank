...
export default function Deposit(){
 ...
 const HandleDeposit= async  (e:React.FormEvent<HTMLElement>)=>{
 e.preventDefault();
 setLoading(false);
setError("");
...
const res= await fetch  ("http://localhost:5005/deposit",{
method:"POST",
headers:{
...
setSuccessMsg(`You have successfully deposited + ${amount}`);
 ...
 useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black-900 flex items-center justify-center p-4 font-sans antialiased">
        ...
        <div className="w-full max-w-lg bg-gray-800 shadow-2xl rounded-xl p-8 space-y-8 border border-gray-700">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-md text-gray-400">
              Transfer funds instantly to your primary checking account.
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={HandleDeposit}>
            ...
            {/* Deposit Button - High contrast black button with white text */}
            <div>
              <button
                type="submit"
                disabled={loading}
          ...
          <p className="text-center text-xs text-gray-600 mt-6 pt-4 border-t border-gray-700">
            All transfers are subject to daily limits and regulatory review. Funds are typically available instantly.
          </p>
        </div>
      </div>
    </>
