    ...
    <div className="w-170 max-w-md mx-auto shadow-2xl rounded-lg overflow-hidden bg- backdrop-blur-sm bg-opacity-90">
        ...
        <div className="p-8 space-y-6 text-white">
            ...
            >
                ...
                <div>
                    <label htmlFor="email" className="font-semibold font-medium block mb-2 text-white">Enter your Full Name  </label>
                    <input 
                    value={name}
             ...
             <LINK      href={"/login"}       className="italic text-blue-500">Already have an account? sign in</LINK>
