...
<div className="flex min-h-screen items-center justify-start ">
  <div className="mx-auto w-full max-w-lg">
    ...
    <p className="mt-3">Email us at steezebank@gmail.com or message us here:</p>
    ...
    <form  className="mt-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2 ">
        <div className="relative z-0">
          <input type="text" name="name" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-md text-white focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
        ...
        <div className="relative z-0">
          <input type="text" name="email" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-md text-white focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
        ...
        <div className="relative z-0 col-span-2">
          <textarea name="message"  className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-md text-white focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" "></textarea>
